<template>
  <div class="container">
    <v-card elevation="2" width="900" height="650">
      ...
      <div class="form-content">
        <v-form class="form-field">
          ...
          <v-btn @click="save" class="save-btn" x-large block>Save</v-btn>
        </v-form>
      </div>
    </v-card>
  </div>
...
//TO DO: This function will be used to trigger save changes (on the user profile) functionality after BE implementation
const save = () => {};
</script>
